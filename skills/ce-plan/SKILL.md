...
Use the platform's question tool when available. When asking the user a question, prefer the platform's blocking question tool if one exists (`ask_user_question` in Claude Code, `request_user_input` in Codex, `ask_user` in Gemini). Otherwise, present numbered options in chat and wait for the user's reply before proceeding.
...
- Run subagent with agent="repo-research-analyst" and task="Scope: technology, architecture, patterns. {planning context summary}".
- Run subagent with agent="learnings-researcher" and task="planning context summary".
...
- Run subagent with agent="best-practices-researcher" and task="planning context summary".
- Run subagent with agent="framework-docs-researcher" and task="planning context summary".
...
- Run subagent with agent="spec-flow-analyzer" and task="planning context summary, research findings".
